...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.blog.category.list')->with(compact('categories'));
    }
    ...
    {
        $categories = $this->category->getCategoryList();
        return view('admin.blog.category.create')->with(compact('categories'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.blog.category.show')->with(compact('category','categories'));
    }
    ...
    public function edit($id)
    {
        $category = $this->category->findCategoryById($id);
        $categories = $this->category->getCategoryList();
        return view('admin.blog.category.edit')->with(compact('category','categories'));
    }
